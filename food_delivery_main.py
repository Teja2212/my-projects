...
quantity=[250,250,8,1,300,1,1,1]
def removeitem():
...
class food_user():
    ...
    def printmenu(self):
        ...
        print("Your order has been succesfully processedd!!!!\nGo to order histroy for info")
        self.displaymainmenu()
    ...
    def orderhistroy(self):
        ...
        for i in range(len(self.arr)):
            print(name[self.arr[i]-1],"\t",price[self.arr[i]-1])
            tot+=price[self.arr[i]-1]
        print("The total bill is :{0}".format(tot))
